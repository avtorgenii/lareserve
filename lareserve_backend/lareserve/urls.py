...
urlpatterns = [
    ...
    path('restaurants/<int:pk>/layout/', views.restaurant_get_layout, name='restaurant-get-layout'),
    path('restaurants/<int:pk>/layout/update/', views.restaurant_update_layout, name='restaurant-update-layout'),
    ...
    path('reservations/today/', views.reservation_list_today, name='reservation-list-today'),
    path('reservations/by-table/', views.reservation_by_table, name='reservation-by-table'),
    ...
    path('reservations/<int:pk>/status/', views.reservation_update_status, name='reservation-update-status'),
